...
def get_version() -> str:
    with open('cat_agent/__init__.py', encoding='utf-8') as f:
        version = re.search(
            r'^__version__\s*=\s*[\'"]([^\'"]*)[\'"]',
            f.read(),
            re.MULTILINE,
...
setup(
    ...
    description='Cat-Agent: Enhancing LLMs with Agent Workflows, RAG, Function Calling, and Code Interpreter.',
    ...
    url='https://github.com/kemalcanbora/cat-agent',
)
